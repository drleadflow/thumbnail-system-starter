...
- **Blueprints** — distill the COMMON structure from 2-5 winning videos (or your own best scripts) into a reusable beat-by-beat skeleton. Then "New from blueprint": a short interview extracts YOUR real material, and the script gets written into the structure — teleprompter-formatted, your phrasing kept, placeholders where you didn't answer. Blueprints accrue your real results over time (avg outlier of videos made from each).
